...
export default function about() {
  ...
  return (
    ...
    >
      ...
      <p>Today, this is is built using React.js. Styles were written leveraging the SASS preprocessor. This site's code is housed in <a href='https://github.com/gvorbeck/iamgarrett-static' title='iamgarrett Repository' rel='noreferrer' target='_blank'>this GitHub repository.</a></p>
    </Article>
  )
}
