...
export const PORTFOLIO_GMCM = "I'm a bit of a nerd at heart and love Dungeons & Dragons. As a Dungeon Master, I wanted to use my developmer skills to create a tool that helped me keep track of complex rules, organize combat scenarios, and create content-rich maps of locations. Thus was born this react-based tool for GatsbyJS - the Game Master's Campaign Manager!";
export const PORTFOLIO_HMC = "When IBM's HMC platform released a new app meant to help system admins manage their Z machines remotely, we needed to get the word out about all this app could do for them. Here, users can learn that they no longer need to be tied to their desks in order to manage these vast systems.";
export const PORTFOLIO_OOM = "I have for most of my life made lists of my favorite records released each year. I don't pretend to be an authority on What Is Good, but with my love of music and penchant for making lists, I built out this nifty little site to keep track of it all. This site uses Last.fm's API to populate album artwork and is built using <a href='https://jekyllrb.com/' title='Jekyll' rel='norefferer' target='_blank'>GitHub's Jekyll static-site builder</a>.";
...
export const PORTFOLIO_KG = "When I got engaged, it probably would have been a lot easier just to use one of those wedding website generators, but being a web developer how could I excuse not building our own? Not content to make life easier, I took my first stab at using React to build a beautiful website for my then-fiancée.";

export const ARTICLE_RESUME = 'resume';
export const ARTICLE_PORTFOLIO = 'portfolio';
export const ARTICLE_ABOUT = 'about';

export const ARTICLE_PORTFOLIO_SUBTITLE = 'Some of My Work';
export const ARTICLE_PORTFOLIO_DESC = 'Here is a selection of some of my most awesome work, both personal and professional.'
export const ARTICLE_PORTFOLIO_IMG_ALT = 'Binder';

export const ARTICLE_ABOUT_SUBTITLE = 'The Right Tools';
export const ARTICLE_ABOUT_DESC = 'I make sure each project is built using the right tools for the job. Work smart, not hard!'
export const ARTICLE_ABOUT_IMG_ALT = 'Info Bubble';
export const ARTICLE_ABOUT_CONTENT = "<p>This site has gone through dozens of iterations in the 20 years that I've owned this domain. Beginning as the home of a musical project I worked on as a teenager, it has shifted as my priorities changed and is now my professional homebase. Each time I introduce a new version of this site I hope to leverage new practices and technologies to ensure a modern experience across devices.</p><p>Today, this is is built using React.js. Styles were written leveraging the SASS preprocessor. This site's code is housed in <a href='https://github.com/gvorbeck/iamgarrett-static' title='iamgarrett Repository' rel='noreferrer' target='_blank'>this GitHub repository</a> and uses GitHub Pages for hosting.</p>";

export const ARTICLE_RESUME_SUBTITLE = 'Just Garrett';
export const ARTICLE_RESUME_DESC = "I'm a front-end developer based in the NYC area with 15+ years of experience. I love to draw, eat pizza, and listen to punk music. I have smiled at every dog I have ever seen. My favorite color is brown. I have been to all 50 states."
...
export const IBM_DESC = "As a FED within IBM's Design Team, I work with the IBM's z/OS mainframe platform to bring a modern web experience to some of the most robust systems in the industry. Whether it is updating the look and feel of their legacy systems, working to create new services, or guiding our sales teams through an ever-updating set of processes; I use my skills to ensure a modern and beautiful interraction every time.";
